/**
 * E2E Tests — rezidence (Playwright)
...
const STUDENT_EMAIL = process.env.TEST_STUDENT_EMAIL || "teststudent@rezidence.ng";
const STUDENT_PASSWORD = process.env.TEST_STUDENT_PASSWORD || "TestPass123!";
const LANDLORD_EMAIL = process.env.TEST_LANDLORD_EMAIL || "testlandlord@rezidence.ng";
